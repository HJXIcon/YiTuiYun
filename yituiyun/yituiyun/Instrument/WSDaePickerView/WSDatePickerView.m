...
//    self.doneButtonColor = UIColorFromRGBString(@"0xf16156");
...
-(void)defaultConfig {
    ...
    if (!self.maxLimitDate) {
        self.maxLimitDate = [NSDate date:@"2023-12-29 23:59" WithFormat:@"yyyy-MM-dd HH:mm"];
    }
    //最小限制
    if (!self.minLimitDate) {
        self.minLimitDate = [NSDate date:@"2010-01-01 00:00" WithFormat:@"yyyy-MM-dd HH:mm"];
    }
}
