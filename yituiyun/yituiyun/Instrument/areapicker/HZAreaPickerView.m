...
- (IBAction)empty:(id)sender {
    if([self.delegate respondsToSelector:@selector(emptyButtonClick:)]) {
        [self.delegate emptyButtonClick:self];
    }
}

- (IBAction)determine:(id)sender {
    if([self.delegate respondsToSelector:@selector(determineButtonClick:)]) {
        [self.delegate determineButtonClick:self];
    }
