...
- (void)setupButtons
{
    self.navigationItem.leftBarButtonItem = [UIBarButtonItem itemWithImage:@"back.png" selectedImage:@"back.png" target:self action:@selector(leftBtnDidClick)];
    ...
    self.navigationItem.rightBarButtonItem.tintColor = kUIColorFromRGB(0x3076a9);
