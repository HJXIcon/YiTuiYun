...
- (void)headerLongPress:(UILongPressGestureRecognizer *)longPress
{
    if (longPress.state == UIGestureRecognizerStateBegan) {
        if(_delegate && _indexPath && [_delegate respondsToSelector:@selector(cellLongPressAtIndexPath:WithTableViewTag:)])
        {
            [_delegate cellLongPressAtIndexPath:self.indexPath WithTableViewTag:self.tableViewTag];
        }
    }
}
