//
//  CommentsAndPraiseAllCircleViewController.m
//  yituiyun
//
...
@interface CommentsAndPraiseAllCircleViewController ()<UITableViewDelegate, UITableViewDataSource, ZQPersonCommentsCellDelegate, UITextViewDelegate,UIAlertViewDelegate, ZHReplayTableViewCellDeleagete, ZHPriseTableViewCellDeleagete,ZHReigonTableViewCellDelegete>
...
@implementation CommentsAndPraiseAllCircleViewController
- (instancetype)init{
    self = [super init];
    if (self) {
...
- (void)tableArrayFromNetwork {
    ...
    __weak CommentsAndPraiseAllCircleViewController *weakSelf = self;
    ...
    NSString *URL = [kHost stringByAppendingString:@"api.php?m=get.uncheckDynamicList"];
...
- (void)setupTableView{
    self.workTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, ZQ_Device_Width, ZQ_Device_Height - 64) style:UITableViewStyleGrouped];
