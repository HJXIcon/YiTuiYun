...
@interface AllyCircleViewController ()<UITableViewDelegate, UITableViewDataSource, ZQPersonCommentsCellDelegate, UITextViewDelegate,UIAlertViewDelegate, ZHReplayTableViewCellDeleagete, ZHPriseTableViewCellDeleagete,ZHReigonTableViewCellDelegete,ReleaseAllyCircleViewControllerDeleagete,CommentsAndPraiseAllCircleViewControllerDeleagete>
...
@implementation AllyCircleViewController
...
- (void)isReadXiao{
    __weak AllyCircleViewController *weakSelf = self;
...
- (void)checkDetail1
{
    ...
    NSInteger i = allyC - [_numString integerValue];
    [USERDEFALUTS setInteger:i forKey:@"allyCircleCount"];
...
- (void)willShowKeyboard:(NSNotification *)aNotification {
    ...
    CommentsModel *model = [_dataArray objectAtIndex:_selectIndexPath.section];
