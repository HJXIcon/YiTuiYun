//
//  JobSearchStrategyViewController.m
//  yituiyun
//
...
@interface JobSearchStrategyViewController ()<UIWebViewDelegate>
@property (nonatomic, strong) UIWebView *web;
@end

@implementation JobSearchStrategyViewController
...
- (void)getAgreement
{
    __weak JobSearchStrategyViewController *weakSelf = self;
