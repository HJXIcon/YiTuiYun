...
@interface ProBillVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    titlelabel.text = @"开票以主账户信息为主,与关联账户无关,关联账号同属主账户";
...
-(void)makesureBtnClick:(UIButton *)btn{
    ...
    if ([ZQ_CommonTool isEmpty:self.model.main_pro_bankName ]) {
        [self showHint:@"请输入主账号-开户行"];
        return ;
    }
    if ([ZQ_CommonTool isEmpty:self.model.main_pro_acount ]) {
        [self showHint:@"请输入主账号-账号"];
        return ;
    }
...
-(NSMutableDictionary *)getParm{
    ...
    parm[@"primary_bank_name"] = self.model.main_pro_bankName;
    parm[@"primary_cardcode"] = self.model.main_pro_acount;
...
-(void)setDescLabelDataWith:(NSString *)str andIndexPath:(NSIndexPath*)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            self.model.main_pro_bankName = str;
            
            
        }else if (indexPath.row == 2){
            self.model.main_pro_acount = str;
    ...
    if (indexPath.section == 0) {
       /***********/
        if (indexPath.row == 0) {
            ...
            cell.descTextField.enabled = YES;
            cell.descTextField.text = self.model.main_pro_bankName;
            cell.descTextField.placeholder = @"请输入开户行";
           
        }else if (indexPath.row == 2){
            cell.nameLabel.text = @"账号:";
            cell.descTextField.enabled = YES;
            cell.descTextField.placeholder = @"请输入账号";
            cell.descTextField.text = self.model.main_pro_acount;
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    if (section == 0) {
        ...
        NSString *titlstr = @"关联账户(关联账号选填,可以修改)";
