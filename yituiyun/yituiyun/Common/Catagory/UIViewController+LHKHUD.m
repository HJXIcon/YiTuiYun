...
@implementation UIViewController (LHKHUD)

-(UINavigationController *)getTabBarVcChilrdVC:(NSInteger)index{
    
   MainViewController *vc = [UIApplication sharedApplication].keyWindow.rootViewController;
    UINavigationController *nav = vc.childViewControllers[index];
    return nav;
